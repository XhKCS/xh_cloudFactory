...
public class FOMainForm extends JFrame {
	...
	public void createEditFacForm() {
		new EditFacForm(this);
	}
	...
	public void updateView() {
		updateView(data);
		mainLabel.setText(myFactory.getName()+"  工厂设备管理");
	}
	...
	public FOMainForm(BeginningForm backForm, FactoryOwner owner) {
		...
		setBounds(500, 150, 793, 735);
		contentPane = new BackgroundPane();
		setContentPane(contentPane);
		contentPane.setLayout(null);
		
		mainLabel = new JLabel(myFactory.getName()+"  工厂设备管理");
		mainLabel.setFont(new Font("SimHei", Font.BOLD, 21));
		mainLabel.setBounds(197, 10, 481, 48);
...
//	    model.addColumn("所属工厂"); //10列的表头名称
		...
		addingButton.setBounds(53, 264, 89, 31);
		...
		rentButton.setBounds(172, 264, 110, 31);
		...
		removingButton.setBounds(384, 264, 95, 31);
		...
		stateButton.setBounds(616, 264, 110, 31);
		...
		backButton.setBounds(574, 625, 118, 39);
		...
		editButton.setBounds(501, 264, 95, 31);
		contentPane.add(editButton);
		
		searchField = new JTextField();
		searchField.setFont(new Font("SimSun", Font.PLAIN, 17));
		searchField.setBounds(66, 144, 294, 35);
		...
		nameSearchButton.setBounds(370, 121, 149, 31);
		...
		cateSearchButton.setBounds(370, 167, 149, 31);
		...
		clearButton.setBounds(563, 146, 103, 31);
		...
		returnButton.setBounds(66, 616, 118, 35);
		contentPane.add(returnButton);
		
		JButton facNameButton = new JButton("修改工厂信息");
		facNameButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				createEditFacForm();
			}
		});
		facNameButton.setFont(new Font("SimSun", Font.BOLD, 15));
		facNameButton.setBounds(22, 50, 140, 38);
		contentPane.add(facNameButton);
